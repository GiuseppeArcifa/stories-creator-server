...
class SchemaManager
{
    ...
    private function ensureStoriesTable(): void
    {
        $expected = [
            ...
            'other_notes' => 'ADD COLUMN `other_notes` TEXT NULL AFTER `teachings`',
            'final_text_generation_id' => 'ADD COLUMN `final_text_generation_id` INT UNSIGNED NULL AFTER `other_notes`',
